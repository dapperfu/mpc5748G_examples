...
int main(void)
{
  ...
  system160mhz();      /* Sets clock dividers= max frequency, calls PLL_160MHz
                          function which:      MC_ME.ME: enables all modes for Mode
                          Entry      module      Connects XOSC to PLL      PLLDIG:
                          LOLIE=1,      PLLCAL3=0x09C3_C000, no sigma-delta, 160MHz
                          MC_ME.DRUN_MC:      configures sysclk = PLL      Mode
                          transition: re-enters DRUN      mode */
