...
uint8_t TCD0_Destination[13] __attribute__((
    aligned(16))); /* Align for cache inhibit variable with SMPU */

uint8_t TCD1_SourceData[] __attribute__((aligned(16))) = {
...
void initTCDs(void) { /* Transfer string to port pin output */
  ...
  EDMA.TCD[1].DADDR.R =
      (vuint32_t)&SIUL2.GPDO[PA10].R; /* Destination address pin port 10*/
