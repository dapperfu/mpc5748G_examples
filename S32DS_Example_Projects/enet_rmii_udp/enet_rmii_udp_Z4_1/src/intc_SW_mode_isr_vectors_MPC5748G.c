...
/*========================================================================*/
void dummy(void);
extern void ENET_Rx_Handler(void);
/*========================================================================*/
/*	GLOBAL VARIABLES */
/*========================================================================*/

const uint32_t __attribute__((section(".intc_vector_table")))
IntcIsrVectorTable[] = {
    ...
    (uint32_t)&dummy, /* Vector #  36 On-Platform periodic timer 0_0 (STM)
                         STM_0_CIR0[CIF] */
    (uint32_t)&dummy, /* Vector #  37 On-Platform periodic timer 0_1 (STM)
                         STM_0_CIR1[CIF] */
    (uint32_t)&dummy, /* Vector #  38 On-Platform periodic timer 0_2 (STM)
                         STM_0_CIR2[CIF] */
    (uint32_t)&dummy, /* Vector #  39 On-Platform periodic timer 0_3 (STM)
                         STM_0_CIR3[CIF] */
    (uint32_t)&dummy, /* Vector #  40 On-Platform periodic timer 1_0 (STM)
                         STM_1_CIR0[CIF] */
    (uint32_t)&dummy, /* Vector #  41 On-Platform periodic timer 1_1 (STM)
                         STM_1_CIR1[CIF] */
    (uint32_t)&dummy, /* Vector #  42 On-Platform periodic timer 1_2 (STM)
                         STM_1_CIR2[CIF] */
    (uint32_t)&dummy, /* Vector #  43 On-Platform periodic timer 1_3 (STM)
                         STM_1_CIR3[CIF] */
    (uint32_t)&dummy, /* Vector #  44 On-Platform periodic timer 2_0 (STM)
                         STM_2_CIR0[CIF] */
    (uint32_t)&dummy, /* Vector #  45 On-Platform periodic timer 2_1 (STM)
                         STM_2_CIR1[CIF] */
    (uint32_t)&dummy, /* Vector #  46 On-Platform periodic timer 2_2 (STM)
                         STM_2_CIR2[CIF] */
    (uint32_t)&dummy, /* Vector #  47 On-Platform periodic timer 2_3 (STM)
                         STM_2_CIR3[CIF] */
    (uint32_t)&dummy, /* Vector #  48 */
    (uint32_t)&dummy, /* Vector #  49 */
    (uint32_t)&dummy, /* Vector #  50 */
    (uint32_t)&dummy, /* Vector #  51 */
    (uint32_t)&dummy, /* Vector #  52 eDMA Combined Error eDMA Channel Error
                         Flags 63-0 */
    ...
    (uint32_t)&dummy, /* Vector # 185 Flash controller Prog/Erase/Suspend IRQ_0
                         MCR[DONE] */
    ...
    (uint32_t)&ENET_Rx_Handler, /* Vector # 211 ENET Interrupt Group1 ENET_1 */
    ...
    (uint32_t)&dummy, /* Vector # 226 Periodic Interrupt Timer (PIT0)
                         PIT_1_TFLG0[TIF] */
    (uint32_t)&dummy, /* Vector # 227 Periodic Interrupt Timer (PIT1)
                         PIT_1_TFLG1[TIF] */
    (uint32_t)&dummy, /* Vector # 228 Periodic Interrupt Timer (PIT2)
                         PIT_1_TFLG2[TIF] */
    (uint32_t)&dummy, /* Vector # 229 Periodic Interrupt Timer (PIT3)
                         PIT_1_TFLG3[TIF] */
    (uint32_t)&dummy, /* Vector # 230 Periodic Interrupt Timer (PIT4)
                         PIT_1_TFLG4[TIF] */
    (uint32_t)&dummy, /* Vector # 231 Periodic Interrupt Timer (PIT5)
                         PIT_1_TFLG5[TIF] */
    (uint32_t)&dummy, /* Vector # 232 Periodic Interrupt Timer (PIT6)
                         PIT_1_TFLG6[TIF] */
    (uint32_t)&dummy, /* Vector # 233 Periodic Interrupt Timer (PIT7)
                         PIT_1_TFLG7[TIF] */
    (uint32_t)&dummy, /* Vector # 234 Periodic Interrupt Timer (PIT8)
                         PIT_1_TFLG8[TIF] */
    (uint32_t)&dummy, /* Vector # 235 Periodic Interrupt Timer (PIT9)
                         PIT_1_TFLG9[TIF] */
    (uint32_t)&dummy, /* Vector # 236 Periodic Interrupt Timer (PIT10)
                         PIT_1_TFLG10[TIF] */
    (uint32_t)&dummy, /* Vector # 237 Periodic Interrupt Timer (PIT11)
                         PIT_1_TFLG11[TIF] */
    (uint32_t)&dummy, /* Vector # 238 Periodic Interrupt Timer (PIT12)
                         PIT_1_TFLG12[TIF] */
    (uint32_t)&dummy, /* Vector # 239 Periodic Interrupt Timer (PIT13)
                         PIT_1_TFLG13[TIF] */
    (uint32_t)&dummy, /* Vector # 240 Periodic Interrupt Timer (PIT14)
                         PIT_1_TFLG14[TIF] */
    (uint32_t)&dummy, /* Vector # 241 Periodic Interrupt Timer (PIT15)
                         PIT_1_TFLG15[TIF] */
    (uint32_t)&dummy, /* Vector # 242 PIT_RTI PIT_RTI */
    (uint32_t)&dummy, /* Vector # 243 SIUL EIRQ [0-7] - SIUL Combined External
                         Interrupt */
    (uint32_t)&dummy, /* Vector # 244 SIUL EIRQ [8-15] - SIUL Combined External
                         Interrupt */
    (uint32_t)&dummy, /* Vector # 245 SIUL EIRQ [16-23] - SIUL Combined External
                         Interrupt */
    (uint32_t)&dummy, /* Vector # 246 SIUL EIRQ [24-31] - SIUL Combined External
                         Interrupt */
    ...
    (uint32_t)&dummy, /* Vector # 255 MC_RGM MC_RGM Functional and destructive
                         reset alternate event interrupt */
    ...
    (uint32_t)&dummy, /* Vector # 259 DSPI0_0 DSPI_0_SR[TFUF] | DSPI_0_SR[RFOF]
                         | DSPI_0_SR[TFIWF] */
    ...
    (uint32_t)&dummy, /* Vector # 264 DSPI0_5 DSPI_0_SR[SPITCF] |
                         DSPI_0_SR[CMD_TCF] */
    (uint32_t)&dummy, /* Vector # 265 DSPI0_6 DSPI_0_SR[DSITCF] |
                         DSPI_0_SR[CMDFFF] */
    ...
    (uint32_t)&dummy, /* Vector # 273 DSPI1_5 DSPI_1_SR[SPITCF] |
                         DSPI_1_SR[CMD_TCF] */
    (uint32_t)&dummy, /* Vector # 274 DSPI1_6 DSPI_1_SR[DSITCF] |
                         DSPI_1_SR[CMDFFF] */
    ...
    (uint32_t)&dummy, /* Vector # 282 DSPI2_5 DSPI_2_SR[SPITCF] |
                         DSPI_2_SR[CMD_TCF] */
    (uint32_t)&dummy, /* Vector # 283 DSPI2_6 DSPI_2_SR[DSITCF] |
                         DSPI_2_SR[CMDFFF] */
    ...
    (uint32_t)&dummy, /* Vector # 291 DSPI3_5 DSPI_3_SR[SPITCF] |
                         DSPI_3_SR[CMD_TCF] */
    (uint32_t)&dummy, /* Vector # 292 DSPI3_6 DSPI_3_SR[DSITCF] |
                         DSPI_3_SR[CMDFFF] */
    ...
    (uint32_t)&dummy, /* Vector # 309 DSPI5_5 DSPI_5_SR[SPITCF] |
                         DSPI_5_SR[CMD_TCF] */
    (uint32_t)&dummy, /* Vector # 310 DSPI5_6 DSPI_5_SR[DSITCF] |
                         DSPI_5_SR[CMDFFF] */
    ...
    (uint32_t)&dummy, /* Vector # 318 DSPI6_5 DSPI_6_SR[SPITCF] |
                         DSPI_6_SR[CMD_TCF] */
    (uint32_t)&dummy, /* Vector # 319 DSPI6_6 DSPI_6_SR[DSITCF] |
                         DSPI_6_SR[CMDFFF] */
    (uint32_t)&dummy, /* Vector # 320 DSPI6_7 DSPI_6_SR[SPEF] | DSPI_6_SR[DPEF]
                       */
    (uint32_t)&dummy, /* Vector # 321 */
    (uint32_t)&dummy, /* Vector # 322 DSPI7_0 DSPI_7_SR[TFUF] | DSPI_7_SR[RFOF]|
                         DSPI_7_SR[TFIWF] */
    ...
    (uint32_t)&dummy, /* Vector # 331 DSPI8_0 DSPI_8_SR[TFUF] | DSPI_8_SR[RFOF]|
                         DSPI_8_SR[TFIWF] */
    ...
    (uint32_t)&dummy, /* Vector # 340 DSPI9_0 DSPI_9_SR[TFUF] | DSPI_9_SR[RFOF]|
                         DSPI_9_SR[TFIWF] */
    ...
    (uint32_t)&dummy, /* Vector # 373 BCTU NDATA0 | NDATA1 | DATA_OVR0 |
                         DATA_OVR1 */
    ...
    (uint32_t)&dummy, /* Vector # 440 I2C_0_0 I2C0_SR[IBAL] | I2C0_SR[TCF] |
                         I2C0_SR[IAAS] */
    (uint32_t)&dummy, /* Vector # 441 */
    (uint32_t)&dummy, /* Vector # 442 I2C_1_0 I2C1_SR[IBAL] | I2C1_SR[TCF] |
                         I2C1_SR[IAAS] */
    (uint32_t)&dummy, /* Vector # 443 */
    (uint32_t)&dummy, /* Vector # 444 I2C_2_0 I2C2_SR[IBAL] | I2C2_SR[TCF] |
                         I2C2_SR[IAAS] */
    (uint32_t)&dummy, /* Vector # 445 */
    (uint32_t)&dummy, /* Vector # 446 I2C_3_0 I2C3_SR[IBAL] | I2C3_SR[TCF] |
                         I2C3_SR[IAAS] */
    ...
    (uint32_t)&dummy, /* Vector # 477 Power Monitor Unit LVD/HVD self checking
                         fault */
    ...
    (uint32_t)&dummy, /* Vector # 484 PLL Indicates PLL Power down process
                         completed by MC_ME */
    ...
    (uint32_t)&dummy, /* Vector # 489 FCCU Interrupt request (miscellaneous
                         conditions) */
    (uint32_t)&dummy, /* Vector # 490 FCCU EOUT interrupt */
    (uint32_t)&dummy, /* Vector # 491 */
    (uint32_t)&dummy, /* Vector # 492 */
    (uint32_t)&dummy, /* Vector # 493 */
    (uint32_t)&dummy, /* Vector # 494 STCU Interrupt request line related to
                         online MBIST execution */
    (uint32_t)&dummy, /* Vector # 495 STCU Interrupt request line related to
                         online LBIST execution */
    ...
    (uint32_t)&dummy, /* Vector # 567 FlexCAN0_2 FLEXCAN_0_ESR_BOFF |
                         FLEXCAN_0_Transmit_Warning | FLEXCAN_0_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 579 FlexCAN1_1 FLEXCAN_1_ESR_BOFF |
                         FLEXCAN_1_Transmit_Warning | FLEXCAN_1_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 591 FlexCAN2_1 FLEXCAN_2_ESR_BOFF |
                         FLEXCAN_2_Transmit_Warning | FLEXCAN_2_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 603 FlexCAN3_1 FLEXCAN_3_ESR_BOFF |
                         FLEXCAN_3_Transmit_Warning | FLEXCAN_3_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 615 FlexCAN4_1 FLEXCAN_4_ESR_BOFF |
                         FLEXCAN_4_Transmit_Warning | FLEXCAN_4_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 627 FlexCAN5_1 FLEXCAN_5_ESR_BOFF |
                         FLEXCAN_5_Transmit_Warning | FLEXCAN_5_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 639 FlexCAN6_1 FLEXCAN_6_ESR_BOFF |
                         FLEXCAN_6_Transmit_Warning | FLEXCAN_6_Receive_Warning
                       */
    ...
    (uint32_t)&dummy, /* Vector # 651 FlexCAN7_1 FLEXCAN_7_ESR_BOFF |
                         FLEXCAN_7_Transmit_Warning | FLEXCAN_7_Receive_Warning
                       */
