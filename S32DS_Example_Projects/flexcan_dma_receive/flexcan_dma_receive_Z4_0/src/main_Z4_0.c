 ...
 */
/*				 Use this project with "flexcan_transmit"
 * project
 */
...
__attribute__((section(".text"))) int main(void) {
  ...
  peri_clock_gating(); /* Configure gating/enabling peripheral
                          clocks(CANs,DMAMUX) for modes*/
...
void peri_clock_gating(void) {    /* Configure gating/enabling peripheral
  ...
  MC_ME.RUN_PC[1].R =
      0x000000FE; /* Configure peripheral clock for all RUN modes */
