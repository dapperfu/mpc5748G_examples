...
void initGPIO(void) {
  ...
  SIUL2.GPDO[PA10].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                    connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PA7].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                   connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PH13].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                    connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PC4].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                   connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PH5].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                   connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PJ4].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                   connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PA0].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                   connected backwards 0 for ON, 1 for OFF */
  ...
  SIUL2.GPDO[PA4].B.PDO_4n = 1; /* Turn LED off, note that the LEDs are
                                   connected backwards 0 for ON, 1 for OFF */
...
void DebouncedWaitTilLow(uint16_t GPIO) {
  ...
  /* debounce */
  while (!SIUL2.GPDI[GPIO].R) {
  }; /* wait here until level is high, if not already */
  do {
    while (SIUL2.GPDI[GPIO].R) {
...
void DebouncedWaitTilHigh(uint16_t GPIO) {
  ...
  /* debounce */
  while (SIUL2.GPDI[GPIO].R) {
  }; /* wait here until level is low, if not already */
  do {
    while (!SIUL2.GPDI[GPIO].R) {
