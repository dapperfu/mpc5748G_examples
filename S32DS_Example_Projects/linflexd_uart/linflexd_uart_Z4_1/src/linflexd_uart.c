...
void initLINFlexD_2(unsigned int MegaHertz, unsigned int BaudRate) {
  ...
  LINFlexD_2.UARTCR.B.UART =
      1; /* UART Enable, Req'd before UART configuration */
  LINFlexD_2.UARTCR.R = 0x0033; /* UART Enable, 1 byte tx, no parity, 8 data*/
  LINFlexD_2.UARTSR.B.SZF =
      1; /* CHANGE THIS LINE   Clear the Zero status bit */
  LINFlexD_2.UARTSR.B.DRFRFE =
      1; /* CHANGE THIS LINE  Clear DRFRFE flag - W1C */
...
void initLINFlexD_1(unsigned int MegaHertz, unsigned int BaudRate) {
  ...
  LINFlexD_1.UARTCR.B.UART =
      1; /* UART Enable, Req'd before UART configuration */
  LINFlexD_1.UARTCR.R = 0x0033; /* UART Enable, 1 byte tx, no parity, 8 data*/
  LINFlexD_1.UARTSR.B.SZF =
      1; /* CHANGE THIS LINE   Clear the Zero status bit */
  LINFlexD_1.UARTSR.B.DRFRFE =
      1; /* CHANGE THIS LINE  Clear DRFRFE flag - W1C */
