/* ###################################################################
**     Filename    : main.c
**     Project     : sema42_multicore_mpc5748g_z4_1
**     Processor   : MPC5748G_324
**     Version     : Driver 01.00
**     Compiler    : GNU C Compiler
**     Date/Time   : 2017-05-31, 12:03, # CodeGen: 4
**     Abstract    :
**         Main module.
...
/*** Processor Expert internal initialization. DON'T REMOVE THIS CODE!!! ***/
  ...
  while (1) {
    ...
    if (SEMA42_DRV_GetGateLocker(SEMA42_INSTANCE, SEMA42_GATE) ==
        (GET_CORE_ID() + 1)) {

      /* Blink the first two LEDs to indicate that the gate is taken by the
       * current CORE */
      delay(360000);
      ...
      /* Blink the first two LEDs to indicate that the gate is being released by
       * this core*/
      delay(1000000);
      PINS_DRV_TogglePins(LED0_PORT, (1 << LED0));
      delay(1000000);
