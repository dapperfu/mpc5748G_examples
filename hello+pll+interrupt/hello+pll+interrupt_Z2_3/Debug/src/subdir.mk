...
"../src/Vector.c" \
"../src/gpio.c" \
"../src/hello+pll+interrupt_Z2_3.c" \
...
./src/Vector.o \
./src/gpio.o \
./src/hello+pll+interrupt_Z2_3.o \
...
./src/Vector.d \
./src/gpio.d \
./src/hello+pll+interrupt_Z2_3.d \
...
src/gpio.o: ../src/gpio.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	powerpc-eabivle-gcc "@src/gpio.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "src/gpio.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '

src/hello+pll+interrupt_Z2_3.o: ../src/hello+pll+interrupt_Z2_3.c
	@echo 'Building file: $<'
	@echo 'Executing target #4 $<'
	@echo 'Invoking: Standard S32DS C Compiler'
	powerpc-eabivle-gcc "@src/hello+pll+interrupt_Z2_3.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "src/hello+pll+interrupt_Z2_3.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
src/pit.o: ../src/pit.c
	...
	@echo 'Invoking: Standard S32DS C Compiler'
	powerpc-eabivle-gcc "@src/pit.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "src/pit.o" "$<"
	@echo 'Finished building: $<'
	@echo ' '
