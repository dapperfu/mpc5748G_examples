...
**
** SPI_0  SLAVE
** CLK	  PF7x  PG13  PH14  PI5  PK11
** SOUT	  PG12x  PH13  PI4  PJ1  PK10
** SIN	  PG10  PI14x  PK9
** SS/CS0 PG11  PH11  PI6  PI15x  PK12
*/
/*****************************************************************************/
...
void init_dspi_3(void) 
{
  ...
  DSPI_3.MODE.CTAR[0].R = 0xB8001111;       /* Configure CTAR0 : Fast as possible : 20MHz : 3 Delays REQUIRED */
  DSPI_3.RSER.R = 0x03000000;               /* Enable DMA for TX */  
}

void init_spi_0(void)
{
  SPI_0.MCR.R = 0x00010001;                 /* Configure SPI_0 as slave */
  SPI_0.MODE.CTAR[0].R = 0x38000000;        /* Configure CTAR0 : 8 Bit  */
  SPI_0.RSER.R = 0x00030000;                /* Enable DMA for RX */
